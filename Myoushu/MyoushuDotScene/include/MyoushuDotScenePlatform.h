...
/**
 * @file MyoushuDotScenePlatform.h
...
#ifndef MYOUSHU_DOTSCENE_PLATFORM_H
#define MYOUSHU_DOTSCENE_PLATFORM_H
...
// If DEBUG or _DEBUG is defined, define MYOUSHU_DOTSCENE_DEBUG
#if (defined(DEBUG) || defined(_DEBUG))
#	if !defined(MYOUSHU_DOTSCENE_DEBUG)
#		define MYOUSHU_DOTSCENE_DEBUG
#	endif
#elif defined(MYOUSHU_DOTSCENE_DEBUG)
#	undef MYOUSHU_DOTSCENE_DEBUG
#endif
...
#	if defined(MYOUSHU_DOTSCENE_DLL)
#		define MYOUSHU_DOTSCENE_API __declspec(dllexport)
#	else
#		define MYOUSHU_DOTSCENE_API __declspec(dllimport)
#	endif
#else
...
#	define MYOUSHU_DOTSCENE_ARCH_TYPE MYOUSHU_DOTSCENE_ARCH_64
...
#	endif
#else
#	define MYOUSHU_DOTSCENE_ARCH_TYPE MYOUSHU_DOTSCENE_ARCH_32
	/** An unsigned integer type to store memory addresses. */
#	ifndef _MSC_VER
