...
/**
 * @file MyoushuOgreOggSoundPlugin.h
...
namespace Myoushu
{
	...
	class MYOUSHU_OGRE_OGG_SOUND_API MyoushuOgreOggSoundPlugin : public Plugin
	{
		public:
			/** Constructor. */
			MyoushuOgreOggSoundPlugin(const std::string& name = "MyoushuOgreOggSound");

			/** Destructor. */
			virtual ~MyoushuOgreOggSoundPlugin();
		...
		protected:
			...
			/** The MyoushuOgreOggSoundFactory instance. */
			MyoushuOgreOggSoundFactory *mpFactory;
	};

	// inlines
	inline MyoushuOgreOggSoundPlugin::MyoushuOgreOggSoundPlugin(const std::string& name) : Plugin(name), mpFactory(NULL)
	{
	}

	inline MyoushuOgreOggSoundPlugin::~MyoushuOgreOggSoundPlugin()
	{
	}
}
