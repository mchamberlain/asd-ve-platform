...
#ifndef MYOUSHU_OGRE_OGG_STREAM_SOUND_H
#define MYOUSHU_OGRE_OGG_STREAM_SOUND_H
...
{
	/** 
	 * An implementation of the StreamSound interface using the OgreOggSound::OgreOggStreamSound class from the OgreOggSound
	 * plugin for OGRE.
	 */
	class MYOUSHU_OGRE_OGG_SOUND_API MyoushuOgreOggStreamSound : public StreamSound, public NamedObject<MyoushuOgreOggStreamSound>
	{
		public:
			/**
			 * Constructor.
			 ...
			 */
			MyoushuOgreOggStreamSound(const std::string& name, OgreOggSound::OgreOggStreamSound *pOgreOggStreamSound) throw (Exception);

			/** Destructor */
			virtual ~MyoushuOgreOggStreamSound();

			CLASS_NAME_FUNCTIONS(MyoushuOgreOggStreamSound);
		...
		protected:
			/** A read/write mutex for thread safety */
			Poco::RWLock mRWLock;
			/** The OgreOggStreamSound instance to use. */
			OgreOggSound::OgreOggStreamSound *mpOgreOggStreamSound;
