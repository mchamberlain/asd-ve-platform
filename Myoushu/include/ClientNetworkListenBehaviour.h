...
/**
 * @file ClientNetworkListenBehaviour.h
 * @author ME Chamberlain
 * @date November 2008
 */

#ifndef MYOUSHU_CLIENT_NETWORK_LISTEN_BEHAVIOUR_H
#define MYOUSHU_CLIENT_NETWORK_LISTEN_BEHAVIOUR_H
...
namespace Myoushu
{
	 ...
	 */
	class MYOUSHU_API ClientNetworkListenBehaviour : public DefaultNetworkListenBehaviour, public NamedObject<ClientNetworkListenBehaviour>
	{
		public:
			/** Constructor. */
			ClientNetworkListenBehaviour();

			/** Destructor */
			virtual ~ClientNetworkListenBehaviour();

			CLASS_NAME_FUNCTIONS(ClientNetworkListenBehaviour);
