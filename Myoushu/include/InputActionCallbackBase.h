...
/**
 * @file InputActionCallbackBase.h
 * @author ME Chamberlain
 * @date May 2008
 */

#ifndef INPUT_ACTION_CALLBACK_BASE_H
#define INPUT_ACTION_CALLBACK_BASE_H
...
{
	/**
	 * The base class for classes that wrap a callback for a specified inputString. If the input system receives an input event
	 ...
	 * It can be a global function, or Lua function.
	 */
	typedef ActionStringCallbackBase<void, InputMessage> InputActionCallbackBase;
}
