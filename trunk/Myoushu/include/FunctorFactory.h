...
#ifndef MYOUSHU_FUNCTOR_FACTORY_H
#define MYOUSHU_FUNCTOR_FACTORY_H
...
{
	/**
	 * Base class of all factories that create FunctorBase instances. Derived factories are defined by plug-ins.
	 */
	class MYOUSHU_API FunctorFactory : public NamedObjectFactory<FunctorBase>
	{
		public:
			/** 
