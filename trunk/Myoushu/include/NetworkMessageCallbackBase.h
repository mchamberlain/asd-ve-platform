...
/**
 * @file NetworkMessageCallbackBase.h
 * @author ME Chamberlain
 * @date January 2009
 */

#ifndef NETWORK_MESSAGE_CALLBACK_BASE_H
#define NETWORK_MESSAGE_CALLBACK_BASE_H
...
namespace Myoushu
{
	 ...
	 */
	typedef ActionStringCallbackBase<bool, NetworkMessage> NetworkMessageCallbackBase;
}
