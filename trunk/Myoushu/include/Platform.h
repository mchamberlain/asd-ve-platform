...
#ifndef MYOUSHU_PLATFORM_H
#define MYOUSHU_PLATFORM_H
...
// If DEBUG or _DEBUG is defined, define MYOUSHU_DEBUG
#if (defined(DEBUG) || defined(_DEBUG))
#	if !defined(MYOUSHU_DEBUG)
#		define MYOUSHU_DEBUG
#	endif
#elif defined(MYOUSHU_DEBUG)
#	undef MYOUSHU_DEBUG
#endif
...
#	if defined(MYOUSHU_DLL)
#		define MYOUSHU_API __declspec(dllexport)
#	else
#		define MYOUSHU_API __declspec(dllimport)
#	endif
#else
#	define MYOUSHU_API
#endif
...
#	define MYOUSHU_ARCH_TYPE MYOUSHU_ARCH_64
...
#	endif
#else
#	define MYOUSHU_ARCH_TYPE MYOUSHU_ARCH_32
	/** An unsigned integer type to store memory addresses. */
#	ifndef _MSC_VER
...
// Integer formats of fixed width
